...
# define S390X_aes_128_CAPABLE ((OPENSSL_s390xcap_P[S390X_KM] &	\
                                 S390X_KM_AES_128) &&		\
                                (OPENSSL_s390xcap_P[S390X_KMC] &\
                                 S390X_KMC_AES_128))
# define S390X_aes_192_CAPABLE ((OPENSSL_s390xcap_P[S390X_KM] &	\
                                 S390X_KM_AES_192) &&		\
                                (OPENSSL_s390xcap_P[S390X_KMC] &\
                                 S390X_KMC_AES_192))
# define S390X_aes_256_CAPABLE ((OPENSSL_s390xcap_P[S390X_KM] &	\
                                 S390X_KM_AES_256) &&		\
                                (OPENSSL_s390xcap_P[S390X_KMC] &\
                                 S390X_KMC_AES_256))
                         ...
                         unsigned char *out, size_t len, int enc)
{
    ...
    S390X_AES_FC(ctx->key) |= S390X_KMA_GCM_LAAD;
    n = ctx->mres;
                                  ...
                                  const unsigned char *iv, int enc)
{
    ...
    if (key) {
        ...
        S390X_AES_FC(&gctx->ks) |= S390X_KMA_GCM_HS;
                                         ...
                                         unsigned char mac[AES_BLOCK_SIZE])
{
    ...
    if (OPENSSL_s390xcap_P[S390X_KMAC] & (1ULL << (63 - S390X_AES_FC(key)))) {
                              ...
                              size_t alen)
{
    ...
    if (OPENSSL_s390xcap_P[S390X_KMAC] & (1ULL <<
                                          (63 - S390X_AES_FC(ctx->key)))) {
